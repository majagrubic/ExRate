...
-(void) setSelectedIndex:(int) index animated:(BOOL) animated
{
	...
	UIButton *zeroButton = (UIButton*) [self viewWithTag:kButtonBaseTag];    
    [self setContentOffset:CGPointMake(zeroButton.frame.origin.x - kLeftOffset, 0) animated:animated];
